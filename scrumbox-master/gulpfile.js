...
var processSass = function() {
  ...
  gulp.src(['stylesheets/bootstrap-social-gh-pages/assets/css/bootstrap.css'])
  .pipe(concatCss('bootstrap.css'))
  .pipe(gulp.dest('dist/css'))
  .pipe(uglifycss())
  .pipe(gulp.dest('dist/css'));

  gulp.src(['stylesheets/bootstrap-social-gh-pages/bootstrap-social.css'])
  .pipe(concatCss('bootstrap-social.css'))
  .pipe(gulp.dest('dist/css'))
  .pipe(uglifycss())
  .pipe(gulp.dest('dist/css'));
};
